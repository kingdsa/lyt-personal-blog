<template>
  <div>
    <BackgroundPlate title="赞赏管理"  color="#f4511e" height="150px"></BackgroundPlate>
    <n-grid :cols="8" >
        ...
        <n-card  :embedded="isdarkTheme" :bordered="!isdarkTheme">
          ...
          >
            <n-space>
              ...
              <n-form-item label="赞赏名称">
                <n-input clearable v-model:value="queryData.labelName" placeholder="请输入赞赏名称" />
              </n-form-item>
    ...
    <n-modal v-model:show="editShowModal">
      <n-card
          ...
          :title="isupdate?'正在编辑['+updateName+']赞赏':'正在新增赞赏'"
          :bordered="false"
          size="huge"
          role="dialog"
          aria-modal="true"
