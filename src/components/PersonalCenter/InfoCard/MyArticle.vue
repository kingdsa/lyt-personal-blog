          ...
          <n-form label-placement="left">
            <n-space>
              <n-form-item label="内容">
                <n-input
                  clearable
                  v-model:value="queryData.articleContent"
                  placeholder="请输入文章内容或标题"
                />
              </n-form-item>
              <n-form-item label="分类">
                <n-select
                  ...
                  style="width: 180px"
                  placeholder="请选择分类"
                  v-model:value="queryData.classifyId"
                  label-field="classifyName"
                  value-field="classifyId"
              ...
              <n-form-item label="状态">
                <n-select
                  ...
                  style="width: 180px"
                  placeholder="请选择状态"
                  v-model:value="queryData.articleState"
              ...
              <n-form-item label="日期">
                <n-date-picker
                  clearable
                  v-model:value="queryData.articleDate"
                  type="date"
                  format="yyy-MM-dd"
                />
              </n-form-item>
              <n-form-item>
                ...
                &nbsp;
                <n-button type="success" @click="addArticle"> 新增 </n-button>
              </n-form-item>
            </n-space>
          </n-form>
...
let { clientWidth, distanceToBottom, distanceToTop, userInfo, isdarkTheme } =
  storeToRefs(store);
//清空
const emptyBtn = () => {
...
const get_ArticlesAll = () => {
  ...
  //假数据
  tableData.value = [
    { articleTitle: "标题", articleId: "123", articleContent: "12312" },
  ];
