<template>
<div>
  <BackgroundPlate title="标签管理"  color="#f4511e" height="150px"></BackgroundPlate>
  <n-grid :cols="8" >
...
<!--     搜索条件-->
      ...
      >
        ...
        <n-form-item label="标签名称">
          <n-input clearable v-model:value="queryData.labelName" placeholder="请输入标签名称" />
        </n-form-item>
...
<!--  编辑-->
  <n-modal v-model:show="editShowModal">
    <n-card
        ...
        :title="isupdate?'正在编辑['+updateName+']标签':'正在新增标签'"
        :bordered="false"
        size="huge"
        role="dialog"
        aria-modal="true"
