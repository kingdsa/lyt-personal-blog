<template>
  <div>
    <BackgroundPlate title="用户管理"  color="#f4511e" height="150px"></BackgroundPlate>
    <n-grid :cols="8" >
          ...
          >
            <n-space>
              ...
              <n-form-item label="用户名称">
                <n-input clearable v-model:value="queryData.labelName" placeholder="请输入用户名称" />
              </n-form-item>
    ...
    <n-modal v-model:show="editShowModal">
      <n-card
          ...
          :title="isupdate?'正在编辑['+updateName+']用户':'正在新增用户'"
          :bordered="false"
          size="huge"
          role="dialog"
          aria-modal="true"
